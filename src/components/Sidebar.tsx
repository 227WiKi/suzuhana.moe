...
export default function Sidebar({ username, user, allUsers }: SidebarProps) {
  ...
  return (
    ...
    <aside className="hidden lg:flex flex-col w-[260px] h-[calc(100vh-24px)] sticky top-3 ml-3 bg-white dark:bg-[#16181c] rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm dark:shadow-none z-50">
